...
public class SoundMC extends ISound.BaseSound {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("jiucore", "element/sound/mc");
    ...
    public JsonObject write(JsonObject data) {
        super.write(data);
        data.addProperty("sound", String.valueOf(BuiltInRegistries.SOUND_EVENT.getKey(this.getSoundEvent())));
    ...
    public void read(JsonObject data) {
        super.read(data);
        this.setSoundEvent(BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse(data.get("sound").getAsString())));
    ...
    public CompoundTag write(CompoundTag data) {
        super.write(data);
        data.putString("sound", String.valueOf(BuiltInRegistries.SOUND_EVENT.getKey(this.getSoundEvent())));
    ...
    public void read(CompoundTag data) {
        super.read(data);
        this.setSoundEvent(BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse(data.getString("sound"))));
