...
public class ItemMetadataAxe extends BaseItemTool.MetaAxe {
	public ItemMetadataAxe() {
		super(JiuCore.MODID, "nbt_axe", JiuCore.CORE, true, ToolMaterial.DIAMOND, Type.values());
